    ...
    <main>
      <section id="section1">
        ...
        <div class="directivity">
          ...
          <a href="collectPage"><h1>Pick Up ></h1></a>
        </div>
        <nav>
      ...
      <section id="section4">
        ...
        <footer>
            ...
            <div class="row_center">
              <a href="#"><ul>Home</ul></a>
              <a href="#"><ul>Store</ul></a>
              <a href="#"><ul>Guid</ul></a>
              <a href="collectPage"><ul>PickUp</ul></a>
              <a href="listpage"><ul>Bord</ul></a>
            </div>       
            <div class="row_SNS">
              <a href="https://www.instagram.com/"><ul>Instagram</ul></a>
              <a href="https://www.facebook.com/?locale=ko_KR"><ul>FaceBook</ul></a>
              <a href="https://www.youtube.com/"><ul>YouTube</ul></a>
            </div>
