...
<body>
	...
	<header>
		...
		<nav>
			<a href="#">Store</a> <a href="#">Guid</a> <a href="#">PickUp</a> <a
				href="#">Board</a> <a href="#"><i class="fa-regular fa-user"></i></a>
		</nav>
	</header>
	<main>
		<section id="section1">
			<div>
				<video src="../Project_Primavera/production_id_4919750 (1080p).mp4"
			...
			<div id="carouselExampleFade" class="carousel slide carousel-fade">
				<div class="carousel-inner">
					<div class="carousel-item active" id="container3">
						...
						<img src="../SemiProject/resources/front_img.jpg" class=""
							alt="...">
					</div>
					...
					<div class="carousel-item" id="container3">
						...
						<img src="../SemiProject/resources/Work_introduce.jpg" class=""
							alt="...">
					</div>
				</div>
			...
			<div id="information">
				...
				<div class="SNS">
					<a href="https://www.instagram.com/"><i
						...
						href="https://www.facebook.com/?locale=ko_KR"><i
