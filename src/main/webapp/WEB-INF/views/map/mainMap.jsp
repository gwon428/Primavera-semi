			...
			<div class="container">
				...
				<div class="card text">
					...
					<div class="contentBx">
						...
						<div class="color">
							<p>
								* 내부 섹션 2개와 내부 포켓 3개 보유 <br> <br> * 탈부착 가능한 체인 스트랩<br>
								<br> * 접이식 플랩, 자석 스냅 버튼
							</p>
						</div>
					</div>
			...
			<div class="container">
				<div class="card text">
					...
					<div class="contentBx">
						...
						<div class="size">
							<h3>
								비닐 소재를 활용하여 업사이클링한<br> 메신저백
							</h3>
						</div>
						<div class="color">
							<p>
								* 데일리로 가볍게 착용가능한 화이트 컬러<br> <br> * 노트북 수납 가능한 안전 포켓 <br>
								<br> * 플랩 안쪽 넉넉한 수납
							</p>
						</div>
					</div>
			...
			<div class="container">
				<div class="card text1">
					...
					<div class="contentBx">
						...
						<div class="size">
							<h3>
								데님 소재를 활용하여 업사이클링한 <br> 루스 핏 롱 데님 팬츠
							</h3>
						</div>
						<div class="color">
							<p>
			...
			<div class="container">
				...
				<div class="card text2">
					...
					<div class="contentBx">
						...
						<div class="size">
							<h3>
								가죽 소재를 활용하여 업사이클링한 <br> 퀄팅 카드 지갑
							</h3>
						</div>
						<div class="color">
							<p>
			...
			<div class="container">
				<div class="card text2">
					...
					<div class="contentBx">
						...
						<div class="size">
							<h3>
								가죽 소재를 활용하여 업사이클링한 <br> 아코디언 카드 홀더
							</h3>
						</div>
						<div class="color">
							<p>
