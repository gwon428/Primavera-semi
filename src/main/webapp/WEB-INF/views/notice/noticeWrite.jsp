	...
	<div class="container">
		...
		<form action="writeNotice" method="post" enctype="multipart/form-data"
			...
			<div class="form-group" id="title">
				<label for="ADMIN_title">title</label> <input class="form-control"
					name="title" id="title_input" maxlength="30"
			...
			<div class="form-group" id="context">
				...
				<textarea class="form-control" row="10" name="content"
					id="content_input"></textarea>
			</div>
			<div class="form-group" id="file">

				<label for="ADMIN_file">파일 업로드</label> <input class="form-control"
