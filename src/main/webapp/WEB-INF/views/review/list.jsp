					...
					<body class="main">
						<main>
							<header>
								...
								<nav>
									<a href="/mainMap">Store</a> <a href="#">Guide</a> <a href="/collectPage">PickUp</a>
								...
								<nav>
									<ul class="pagination">
										<li class="page-item ${paging.prev ? '' : 'disabled'}"><a class="page-link"
												href="/review/list?page=${paging.startPage - 1}">Previous</a>
										</li>

										<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="pageNum">
											<li class="page-item ${pageNum == paging.page ? 'active' : ''}"><a
													class="page-link"
													href="/review/list?page=${pageNum}&sort=${paging.sort}&searchType=${searchType}&searchKeyword=${encodedSearchKeyword}">${pageNum}</a>
											</li>
										</c:forEach>

										<li class="page-item ${paging.next ? '' : 'disabled'}"><a class="page-link"
												href="/review/list?page=${paging.endPage + 1}">Next</a>
										</li>
									</ul>
								</nav>
